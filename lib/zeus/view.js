...
// Init the app.core.view
app.core.view = {};

// Set required dependencies
app.core.view.requiredLib = [ 'log' ];
...
app.core.view.onFrameworkInit = function() {
    // Preload all views	
    app.core.view.preload(function() {
 ...
 * @param Function thenCallback
 */
app.core.view.render = function(file, data, callback, thenCallback) {
 ...
 */
app.core.view.preload = function(callback) {
